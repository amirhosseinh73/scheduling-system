        ...
        <div class="card bg-primary">
            <div class="card-body">
                ...
                <div class="row justify-content-end">
                    <div class="col-8">
                        <div class="mt-3">
                            <img src="<?= base_url() ?>/assets/template/images/widget-img.png" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <div>
                                ...
                                <div class="media mt-4 pt-1">
                                    <div class="avatar-sm mr-3">
                                        <img src="<?= base_url() ?>/assets/template/images/users/avatar-4.jpg" alt="" class="img-fluid rounded-circle">
                                    </div>
                                    <div class="media-body">
                ...
                <ul class="inbox-wid list-unstyled">
                        ...
                        <a href="#">
                            <div class="media">
                                <div class="mr-3 align-self-center">
                                    <img src="<?= base_url() ?>/assets/template/images/users/avatar-3.jpg" alt="" class="avatar-sm rounded-circle">
                                </div>
                    ...
                    <li class="inbox-list-item">
                        <a href="#">
                            <div class="media">
                                <div class="mr-3 align-self-center">
                                    <img src="<?= base_url() ?>/assets/template/images/users/avatar-4.jpg" alt="" class="avatar-sm rounded-circle">
                                </div>
                                <div class="media-body overflow-hidden">
                    ...
                    <li class="inbox-list-item">
                        <a href="#">
                            <div class="media">
                                <div class="mr-3 align-self-center">
                                    <img src="<?= base_url() ?>/assets/template/images/users/avatar-5.jpg" alt="" class="avatar-sm rounded-circle">
                                </div>
                                <div class="media-body overflow-hidden">
                    ...
                    <li class="inbox-list-item">
                        <a href="#">
                            <div class="media">
                                <div class="mr-3 align-self-center">
                                    <img src="<?= base_url() ?>/assets/template/images/users/avatar-6.jpg" alt="" class="avatar-sm rounded-circle">
                                </div>
                                <div class="media-body overflow-hidden">
