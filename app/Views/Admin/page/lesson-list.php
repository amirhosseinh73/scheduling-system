<article class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">لیست درس ها</h4>

                <button id="btn_lesson_create" type="button" class="btn btn-success px-5 waves-effect waves-light mb-4 ml-auto d-block">ایجاد</button>
                ...
                <div class="table-responsive">
                    <table class="table table-centered">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col">عنوان سر فصل مربوطه</th>
