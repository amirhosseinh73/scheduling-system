                    ...
                    <section class="accordion-item">
                        ...
                        <div id="faq_a_1" class="accordion-collapse collapse show" aria-labelledby="faq_q_1" 
                            ...
                            <div class="accordion-body">
                                <table id="table_QA_patient" class="table table-responsive table-secondary table-striped table-bordered table-hover mb-0 font-size-0-8">
                                    <thead>
                                        <tr>
                    ...
                    <section class="accordion-item">
                        <h2 class="accordion-header" id="faq_q_2">
                            ...
                            data-bs-target="#faq_a_2" aria-expanded="false" aria-controls="faq_a_2">
                                <p class="mb-0 d-block w-100 text-center">پرسش های دیگران</p>
                            </button>
                        </h2>
